...
public enum ModArmorMaterial implements ArmorMaterial {
    SAPPHIRE("sapphire", 30, new int[]{3, 6, 7, 3}, 4, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, 0.5F, () -> {
        return Ingredient.ofItems(ModItems.SAPPHIRE);
    }),
    ETHERITE("etherite", 42, new int[]{6, 9, 11, 6}, 4, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 4.0F, () -> {
